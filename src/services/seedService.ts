...
export const seedService = {
    async seedDatabase() {
        ...
        } catch (e) { console.warn('Skipping contractors', e); }
        ...
        try {
            ...
            if (!orderError) {
                ...
                console.warn('Orders table not ready or schema mismatch:', orderError.message);
            }
        } catch (e) {
            console.warn('Skipping Orders seeding - table might be missing', e);
        }
